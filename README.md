# AI CMO OS — AI Growth Operating System

> Policy-aware, approval-gated, evidence-backed growth intelligence platform.
...
cd ai-cmo-os
cp .env.example .env
# Optional: add ANTHROPIC_API_KEY for real AI output
# Without it, agents return demo placeholder content
```
...
This starts: PostgreSQL, Redis, Temporal, API (port 8000), Worker, Frontend (port 3000).
