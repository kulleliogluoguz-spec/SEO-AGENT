...
export default function LearningError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-5 text-center">
      ...
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-1">Learning failed to load</h2>
        <p className="text-sm text-gray-500 max-w-sm">
          {error.message || 'An unexpected error occurred while loading the learning page.'}
        </p>
      </div>
      <button
        onClick={reset}
