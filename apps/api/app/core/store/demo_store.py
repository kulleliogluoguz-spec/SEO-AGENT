...
def _seed() -> dict:
    ...
    for _i, (title, atype, status) in enumerate(
        [
            ...
            "sections": [
                {
                    ...
                    "content": "Beginner fitness content is surging (+82% momentum). Recovery and sleep content is emerging as the #2 growth opportunity for your niche.",
                },
                {
                    "title": "Audience Insights",
                    "content": "Your highest-fit segment (Fitness Beginners) has 31M reach on Instagram. Content angle: zero-judgment, step-by-step transformation stories.",
                },
                {
                    "title": "Top Recommendations",
                    "content": "Shift to Reels-first content strategy (4+ Reels/week drives 3–5× growth). Optimize your Instagram bio with niche keywords. Build a 30-day beginner challenge series.",
                },
            ],
            "created_at": _now(),
        }
...
"""
            ...
            "sections": [
                {
                    ...
                    "content": "Instagram 40% (community & product sales, CPM $5–14). YouTube 25% (deep engagement & trust building). TikTok 20% (viral reach & Gen Z acquisition). Google Search 15% (high-intent product capture, CPC $1–3).",
                },
                {
                    "title": "Budget Guidance",
                    "content": "Starter: $1,000–3,000/month. Growth: $3,000–10,000/month. Scale: $10,000+/month. Begin with organic proof-of-concept before scaling paid.",
                },
                {
                    "title": "Priority Tests",
                    "content": "Test 1: Transformation story Reels vs. workout demo Reels (3 weeks). Test 2: YouTube 15s vs. 30s pre-roll (4 weeks). Test 3: Video viewer retargeting vs. engagement audiences (2 weeks).",
                },
            ],
            "created_at": _now(),
        }
        ...
        data["approvals"].append(
            {
                ...
                "title": title,
                "description": "AI-generated suggestion for your brand's growth strategy.",
                "risk_level": risk,
                "policy_flags": [],
                "status": "pending",
                "created_at": _now(),
    ...
    for title, category, impact, effort, priority, summary, action in [
        ...
        (
            "Create pillar content for 'beginner fitness'",
            "content_gap",
            0.79,
            0.55,
            0.84,
        ...
        (
            "Fix broken internal links (12 found)",
            "technical_seo",
            0.71,
            0.2,
            0.79,
        ...
        (
            "Improve page speed — LCP > 4s on mobile",
            "technical_seo",
            0.74,
            0.65,
            0.77,
...
def get_content_assets(
    workspace_id: str, asset_type: str | None = None, status: str | None = None
) -> list[dict]:
