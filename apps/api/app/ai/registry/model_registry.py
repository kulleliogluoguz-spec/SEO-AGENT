...
class ModelCard:
    ...
    quantization: str | None = None  # e.g. "Q4_K_M", "AWQ", "GPTQ"
...
class ModelRegistry:
    ...
    def get_primary_for_role(self, role: AIRole) -> ModelCard | None:
    ...
    def get_fallback_for_role(self, role: AIRole) -> ModelCard | None:
        candidates = self.list_for_role(role)
