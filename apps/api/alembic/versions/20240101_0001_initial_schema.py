...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "invited_by_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "site_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("sites.id"), nullable=True
        ),
        sa.Column("title", sa.String(512), nullable=False),
    ...
    op.create_index(
        "ix_content_assets_workspace_type", "content_assets", ["workspace_id", "asset_type"]
    )
    ...
    op.create_index(
        "ix_activity_workspace_created", "activity_logs", ["workspace_id", "created_at"]
    )
