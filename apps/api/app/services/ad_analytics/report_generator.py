...
class ReportGenerator:
    def generate_weekly_pdf(
        self, report_data: dict, workspace_name: str = "Growth"
    ) -> str:
        try:
        ...
        story.append(
            Paragraph(f"{workspace_name} — {date.today()}", styles["Normal"])
        )
        ...
        footer = ParagraphStyle(
            "F", parent=styles["Normal"], fontSize=8, textColor=colors.grey
        )
        story.append(
            Paragraph("Generated by AI Growth OS. AI estimates only.", footer)
        )
