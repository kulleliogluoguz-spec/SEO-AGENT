...
revision = "mktg_001"
down_revision = "0001"  # Chains to initial schema (creates workspaces table)
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_approvals_workspace_decision", "content_approvals", ["workspace_id", "decision"]
    )
    ...
    op.create_unique_constraint(
        "uq_workspace_channel", "channel_connectors", ["workspace_id", "channel"]
    )
